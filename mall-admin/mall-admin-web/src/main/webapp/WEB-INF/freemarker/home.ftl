...
<head>
    ...
    <link rel="stylesheet"     href="../res/assets/css/codemirror.css">
    <!--[if IE 7]>
    ...
    <!-- <![endif]-->
    <script src="../res/assets/dist/echarts.js"></script>
